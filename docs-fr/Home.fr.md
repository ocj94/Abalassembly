🇬🇧 [English version](../docs-en/Home.en.md)
...
- **[Mode Enfant](Mode-Enfant.fr.md)** — laisser un jeune joueur seul devant l'écran, sortie protégée.
- **[Confort & accessibilité](Accessibilite.fr.md)** — réglages qui changent réellement l'affichage et le rythme.
- **[Profil de performance](Profil-de-performance.fr.md)** — indicateurs définis, calculés, situés contre un corpus réel.
- **[Échanger des parties](Echanger-des-parties.fr.md)** — partie par code, format APGN.
- **[Puzzles](Puzzles.fr.md)** — comment la bibliothèque est vérifiée contre le moteur.
- **[Historique](Historique.fr.md)** — tes parties passées, filtrables et rejouables.
- **[Empreintes historiques](Empreintes-historiques.fr.md)** — rareté, trajectoire, corrélations avec la victoire.
- **[Benchmark moteur](Benchmark-moteur.fr.md)** — méthodologie et chiffres réellement mesurés.
- **[Architecture](Architecture.fr.md)** — trois schémas : moteur, données, modes de jeu.
- **[Calcul distribué](Calcul-distribue.fr.md)** — pourquoi il n'y a pas de grille de calcul volontaire.
- **[Moteur multi-worker](Moteur-multi-worker.fr.md)** — ce qui marche, et une vraie limite non résolue, documentée honnêtement.
- **[Variantes](Variantes.fr.md)** — jouables contre documentées seulement, à travers les trois endroits du site qui en parlent.
- **[Glossaire des fonctions](Glossaire-fonctions.fr.md)** — 1236 fonctions extraites du code réel, classées par lettre avec leur section de code.

## En bref

- **Jouer** : [ocj94.github.io/Abalassembly](https://ocj94.github.io/Abalassembly/)
- **4 479 parties** embarquées, rejouables coup par coup
- **2 589 parties MiGs** republiées en [APGN](../APGN.fr.md), sauvées d'un serveur fermé en 2017
