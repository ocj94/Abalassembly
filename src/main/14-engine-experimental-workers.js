...
function forceAINow() {
  ...
  try {
    ...
    if (!moves.length) { if (typeof HumanColor!=='undefined'){ CurrentTurn.set(HumanColor.get()); updateStatus(); } _aiForcing = false; return; }
    ...
    if (typeof HumanColor!=='undefined'){ CurrentTurn.set(HumanColor.get()); updateStatus(); }
  }
  _aiForcing = false;
}
